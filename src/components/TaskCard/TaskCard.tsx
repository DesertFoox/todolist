...
const TaskCard: React.FC<TaskCardProps> = ({ title, creator, tag, description, startDate, endDate }) => {
  ...
  return (
    <div className="bg-white rounded-lg p-4 shadow-md mb-2">
      ...
      <p className="text-[#9B7B8A] text-sm mb-2 bg-[#F5E0E9] w-[5rem] text-center rounded px-2">{tag}</p>
      <p className="text-gray-500 text-sm mb-2 px-2">Creator: {creator}</p>
      <p className="text-gray-500 text-sm mb-2 px-2">{startDate} {'--->'} {endDate}</p>
